-- =============================================================
-- Seed-data: delade exempelfrågor (owner_id = null) i alla ämnen
-- så att plattformen går att testa direkt.
-- Kör efter 0001_init.sql, t.ex. via Supabase SQL Editor.
-- =============================================================
...
-- ---------------- BIOLOGI ----------------
(null, 'biologi', 9, 'Evolutionens mekanismer och organismers utveckling',
 'flerval_ett',
